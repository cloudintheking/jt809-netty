package io.github.cloudintheking.jt809.constants;

public interface MsgIdConstant {
    ...
    public static int UP_DISCONNECT_REQ = 0x1003;//主链路注销请求消息

    public static int UP_DISCONNECT_RSP = 0x1004;//主链路注销应答消息

    public static int UP_LINKETEST_REQ = 0x1005;//主链路连接保持请求消息

    public static int UP_LINK_TEST_RSP = 0x1006;//主链路连接保持应答消息

    public static int UP_DISCONNECT_INFORM = 0x1007;//主链路断开通知消息

    public static int UP_CLOSE_LINK_INFORM = 0x1008;//下级平台主动关闭链路通 知消息
